...
1. **`ggplotly()` converts ggplot2 to interactive** - easiest path to interactivity
   ...
   ```
2. **Use cases**:
   - ✅ Data exploration - zoom, pan, hover for exact values
   - ✅ HTML presentations - engage your audience
   - ✅ Interactive reports - let readers explore
   - ❌ Publications - journals require static figures
   - ❌ Print - obviously doesn't work
...
- [plotly for R book](https://plotly-r.com/) - comprehensive guide by Carson Sievert
- [ggplotly documentation](https://plotly.com/ggplot2/) - official reference
- [ggiraph package](https://davidgohel.github.io/ggiraph/) - alternative with better ggplot2 compatibility
- [crosstalk](https://rstudio.github.io/crosstalk/) - linking multiple HTML widgets
- [htmlwidgets](http://www.htmlwidgets.org/) - R interface to JavaScript libraries
:::
