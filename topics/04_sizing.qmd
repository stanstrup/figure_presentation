...
# Small figure → smaller text
ggsave("small.pdf", p, width = 3, height = 2)

# Large figure → larger text
...
ggsave("small.pdf", p, width = 3, height = 3)   # 3" × 3"
ggsave("large.pdf", p, width = 9, height = 9)   # 9" × 9"
...
```{r}
#| label: sizing-individual-elements
#| echo: true
#| eval: false
