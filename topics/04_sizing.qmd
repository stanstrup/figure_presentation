...
ggsave("sources/sizing_default_theme.svg", p_default, width = 4, height = 3)
ggsave("sources/sizing_custom_theme.svg", p_custom, width = 4, height = 3)
```
...
![](sources/sizing_default_theme.svg){width="100%"}
...
![](sources/sizing_custom_theme.svg){width="100%"}
