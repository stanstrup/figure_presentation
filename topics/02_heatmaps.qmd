...
# Create asterisk markers for capped values
asterisk_matrix <- matrix("", nrow = nrow(capped_cells), ncol = ncol(capped_cells))
asterisk_matrix[capped_cells] <- "*"
asterisk_matrix <- asterisk_matrix[p_temp$tree_row$order, p_temp$tree_col$order]

# Now create final plot with asterisk markers
...
asterisk_matrix_q <- asterisk_matrix_q[p_temp_q$tree_row$order, p_temp_q$tree_col$order]
...
asterisk_matrix_comp <- asterisk_matrix_comp[p2_temp$tree_row$order, p2_temp$tree_col$order]
