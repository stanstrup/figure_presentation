...
**Key function:** `ggarrange()`

- Alternative to patchwork for combining plots
- Built-in panel labeling (A, B, C)
- `stat_cor()` adds correlation statistics
- Works seamlessly with ggpubr themes
:::
:::
