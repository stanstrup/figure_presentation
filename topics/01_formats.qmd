...
# Crop and zoom on the text area
crop_geom <- "200x100+800+50"
vector_crop <- image_crop(vector_img, crop_geom) %>% image_scale("600x300")
highres_crop <- image_crop(highres_img, crop_geom) %>% image_scale("600x300")
lowres_crop <- image_crop(lowres_img, crop_geom) %>% image_scale("600x300")
jpeg_crop <- image_crop(jpeg_img, crop_geom) %>% image_scale("600x300")
