...
vector_img <- image_read_svg("plots/01_formats/vector_demo.svg", width = 800)
raster_img <- image_read("plots/01_formats/raster_demo.png")
...
ggsave("plots/01_formats/raster_300dpi.png", p_base, width = 8, height = 4, dpi = 300)

# Save as low-res PNG (72 DPI) - 576 × 288 pixels
ggsave("plots/01_formats/raster_72dpi.png", p_base, width = 8, height = 4, dpi = 72)

# Read the saved images
highres_img <- image_read("plots/01_formats/raster_300dpi.png")
lowres_img <- image_read("plots/01_formats/raster_72dpi.png")
...
# Save as vector (PDF)
ggsave("plots/01_formats/demo_vector.pdf", p, width = 8, height = 3, device = cairo_pdf)

# Save as high-res PNG (300 DPI)
ggsave("plots/01_formats/demo_highres.png", p, width = 8, height = 3, dpi = 300)

# Save as low-res PNG (72 DPI) - simulate poor quality
ggsave("plots/01_formats/demo_lowres.png", p, width = 8, height = 3, dpi = 72)

# Save as JPEG (lossy compression)
ggsave("plots/01_formats/demo_jpeg.jpg", p, width = 8, height = 3, dpi = 150, quality = 75)
...
flowchart LR
    ...
    B1 -->|Publication| B2[High-res TIFF<br/>300+ DPI]
    B1 -->|Presentation/Web| B3[JPEG or PNG<br/>150 DPI]

    C --> C1{Where will it<br/>be used?}
    C1 -->|Publication| C2[High-res PNG<br/>300+ DPI]
    C1 -->|Presentation/Web| C3[PNG<br/>150 DPI]

    D --> D1{Publication or<br/>presentation?}
    D1 -->|Publication| D2{Vector support?}
    D1 -->|Presentation| D3{Need<br/>transparency?}

    D2 -->|Yes| D4[PDF / SVG / EPS<br/>All equivalent vectors]
    D2 -->|No| D5[TIFF 600 DPI LZW<br/>PNG not supported]

    D3 -->|Yes| D6[PNG<br/>transparent BG]
    D3 -->|No| D7[PNG or PDF<br/>quick & dirty]

    style D4 fill:#2ecc71
    style D5 fill:#f39c12
    style D6 fill:#9b59b6
    style D7 fill:#95a5a6
...
ggsave("plots/01_formats/temp_jpeg.jpg", p2, width = 4, height = 4, dpi = 150, quality = 60)
...
ggsave("plots/01_formats/compare_vector.pdf", comparison_plot,
