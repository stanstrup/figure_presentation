...
vector_crop <- vector_img %>%
  image_crop(glue("{150*oversize_scale}x{75*oversize_scale}+{250*oversize_scale}+{20*oversize_scale}")) %>%
  image_scale("600x300")
...
highres_crop <- image_read("plots/01_formats/compare_highres.png") %>%
  image_crop(glue("{150*scale_300}x{75*scale_300}+{250*scale_300}+{20*scale_300}")) %>%
  image_scale("600x300")

# PNG 72 DPI: Native size is 432x288 (6" * 72 DPI) - our baseline
scale_72 <- 1
lowres_crop <- image_read("plots/01_formats/compare_lowres.png") %>%
  image_crop(glue("{150*scale_72}x{75*scale_72}+{250*scale_72}+{20*scale_72}")) %>%
  image_scale("600x300")
...
jpeg_crop <- image_read("plots/01_formats/compare_jpeg.jpg") %>%
  image_crop(glue("{150*scale_150}x{75*scale_150}+{250*scale_150}+{20*scale_150}")) %>%
  image_scale("600x300")
