...
![](plots/01_formats/artifacts_original.png)
:::

::: {.column width="50%"}
**After JPEG Compression (Quality 60)**

![](plots/01_formats/artifacts_jpeg.jpg)
:::
:::
...
::: {.columns}
::: {.column width="50%"}
**Vector (SVG) - Infinite zoom, always crisp**

![](plots/01_formats/compare_vector.svg)
:::

::: {.column width="50%"}
**High-res PNG (300 DPI) - Good quality**

![](plots/01_formats/compare_highres.png)
:::
:::

::: {.columns}
::: {.column width="50%"}
**Low-res PNG (72 DPI) - Pixelated when zoomed**

![](plots/01_formats/compare_lowres.png)
:::

::: {.column width="50%"}
**JPEG (Quality 60) - Compression artifacts**

![](plots/01_formats/compare_jpeg.jpg)
:::
:::
