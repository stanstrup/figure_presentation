...
# Default - separate axes
p1 / p2 / p3

# Share x-axes (for stacked plots)
p1 / p2 / p3 +
  plot_layout(axes = "collect_x")

# Share y-axes (for side-by-side)
p1 | p2 | p3 +
...
- **`collect`**: Remove both (same scales in both directions)
