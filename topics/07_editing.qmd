...
1. Select the objects you want to keep (or Select All)
...
R exports often contain many **invisible/empty objects** that prevent proper cropping!

![](../sources/hidden_objects.png){width=80%}

**The frustrating whack-a-mole problem:**

- Press **Ctrl+A** (Select All) to reveal hidden objects
- You'll see many white/empty rectangles and objects
- **Delete these empty objects first** before resizing page
- Otherwise, your canvas will include this invisible whitespace
- This is tedious but necessary for clean cropping

**Why clipping doesn't work:**

- Object → Clip → Set can destroy your plot elements
- May convert gradients/fills to colored rectangles
- **Don't use clipping** - just delete empty objects instead
:::

## Handling Missing Fonts

When opening files in Inkscape, you may see a font warning:

![](../sources/keep_font_names.png){width=70%}

**Important: Keep the font names!**

::: {.callout-tip}
## Why keep missing font names?

- Preserves original font information
- If you substitute fonts, you can't revert later
- Fonts may be available on other systems (e.g., when submitting to journals)
- You can always change fonts manually later if needed
- Prevents unexpected text reflow or sizing issues
:::
...
::: {.columns}
::: {.column width="50%"}
**Original R output (pre-edit.svg)**

![](../sources/pre-edit.svg){width=100%}
:::

::: {.column width="50%"}
**After editing in Inkscape (post-edit.svg)**
