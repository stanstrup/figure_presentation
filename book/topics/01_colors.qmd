...
::: {.aside}
*Figure from Gołębiowska & Çöltekin (2022), ISPRS Journal. Used under fair use for educational purposes.*
:::
:::
...
![](sources/file-20211005-30173-hog6m.avif)

::: {.aside}
*Image from The Conversation. Licensed under CC BY-ND 4.0.*
:::
...
::: {.aside}
*Figure from Haseneyer et al. (2011), BMC Plant Biology. Licensed under CC BY 2.0.*
:::
...
::: {.aside}
*Figure from Borkin et al. (2011), IEEE. Used under fair use for educational purposes.*
:::
...
- [The misuse of colour in science communication](https://www.nature.com/articles/s41467-020-19160-7) - Crameri et al., Nature Communications
- [What's wrong with the rainbow?](https://doi.org/10.1016/j.isprsjprs.2022.10.002) - Gołębiowska & Çöltekin, ISPRS Journal  
