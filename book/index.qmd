...
Navigate using the sidebar on the left, or start with [Chapter 1: Color Gradients](../topics/01_colors.qmd). Each chapter is self-contained with code examples you can run yourself.
