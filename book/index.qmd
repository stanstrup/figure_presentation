...
Test your knowledge with 31 questions covering all topics! The quiz runs as an interactive R Shiny app, so it only works locally (not on the web). See the [Quiz Information appendix](quiz-info.html) for instructions.
